import PayWithButton from "./PayWithButton";
		...
		<section className="front_blur_background flex flex-col justify-center items-center gap-6 px-4 py-6 glowing_shadow rounded-md max-w-[40rem]">
			...
			<div className="flex flex-col gap-10">
				...
				<div className="flex flex-col gap-2 opacity-60 hover:opacity-100 transition-opacity duration-700 ">
					...
					<p className="text-lg">
						The basic growth ivestment plan is the best plan for money with an
						excellent return rate , this will in no time give you back uor
